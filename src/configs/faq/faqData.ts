...
export const faqData : FaqDataType[] = [
  ...
  {
    id: "item-2",
    trigger: "Why use Launch UI instead of a no-code tool?",
    content: [
  ...
  {
    id: "item-3",
    trigger: "How Launch UI is different from other components libraries and templates?",
    content: [
  ...
  {
    id: "item-4",
    trigger: "Why exactly does it mean that \"The code is yours\"?",
    content: [
  ...
  {
    id: "item-5",
    trigger: "Are Figma files included?",
    content: [
